...
class StatisticsMoneyDriverDetailScreen extends StatefulWidget {
  static const String route = '/statistics/money/driver-detail';

  final int driverId;
  final String driverName;

  const StatisticsMoneyDriverDetailScreen({
    super.key,
  ...
  @override
  State<StatisticsMoneyDriverDetailScreen> createState() =>
      _StatisticsMoneyDriverDetailScreenState();
}

class _StatisticsMoneyDriverDetailScreenState
    extends State<StatisticsMoneyDriverDetailScreen> {
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 2.h),
                          _SectionHeader(title: l.driverEarningsSection),
                          SizedBox(height: 1.h),
                          _MoneyCard(
                            label: l.driverNetEarnings,
