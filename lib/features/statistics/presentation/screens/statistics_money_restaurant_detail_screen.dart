...
class StatisticsMoneyRestaurantDetailScreen extends StatefulWidget {
  static const String route = '/statistics/money/restaurant-detail';

  final int restaurantId;
  final String restaurantName;

  const StatisticsMoneyRestaurantDetailScreen({
    super.key,
  ...
  @override
  State<StatisticsMoneyRestaurantDetailScreen> createState() =>
      _StatisticsMoneyRestaurantDetailScreenState();
}

class _StatisticsMoneyRestaurantDetailScreenState
    extends State<StatisticsMoneyRestaurantDetailScreen> {
  ...
  Future<_MoneyStats> _fetchStats() async {
    final dio = sl<Dio>();
    final q = <String, dynamic>{'restaurant_id': widget.restaurantId};
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 2.h),
                          _SectionHeader(title: l.restaurantEarningsSection),
                          SizedBox(height: 1.h),
                          _MoneyCard(
                            label: l.restaurantNetEarnings,
