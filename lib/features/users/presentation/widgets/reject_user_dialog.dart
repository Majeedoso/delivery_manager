      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              localizations.rejectingUser(widget.userName),
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                labelText: localizations.rejectionReasonLabel,
              ...
              validator: (value) {
                if (value == null || value.trim().isEmpty) {
                  return localizations.rejectionReasonRequired;
                }
              ...
              children: [
                ...
                Expanded(
                  child: ElevatedButton(
                    ...
                    child: Text(localizations.rejectUser),
                  ),
                ),
              ],
            ),
