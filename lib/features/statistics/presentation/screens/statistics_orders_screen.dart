...
class StatisticsOrdersScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(l.statisticsOrders)),
      body: Container(
                ...
                Wrap(
                  ...
                  children: [
                    _buildIconContainer(
                      ...
                      onTap: () => Navigator.of(
                        context,
                      ).pushNamed(AppRoutes.statisticsOrdersOverview),
                    ),
                    _buildIconContainer(
                      context,
                      ...
                      onTap: () => Navigator.of(
                        context,
                      ).pushNamed(AppRoutes.statisticsOrdersRestaurants),
                    ),
                    _buildIconContainer(
                      context,
                      title: l.driversTab,
                      ...
                      onTap: () => Navigator.of(
                        context,
                      ).pushNamed(AppRoutes.statisticsOrdersDrivers),
                    ),
                  ],
                ),
                SizedBox(height: 4.h),
